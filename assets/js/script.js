$(function () {
	...
	// Globals variables
	var search = $(".search"), menu = $(".menu");
	search.click(function(){alert("search clicked!");});
	menu.click(function(){alert("menu clicked!");});
	...
	function renderFilterResults(filters, products){
		...
		var criteria = ['destination','price','weather','hiking','beach','nightlife'],
			results = [],
			isFiltered = false;
